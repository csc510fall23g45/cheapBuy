...
The following is a set of guidelines for contributing to "cheapBuy" and its packages, which are hosted in the [cheapBuy](https://github.com/csc510fall23g45/cheapBuy) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request. <br>
...
## Code of Conduct
This project and everyone participating in it is governed by the [Code of Conduct](https://github.com/csc510fall23g45/cheapBuy/blob/Project3/CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to sefall2023project45@gmail.com.
...
* [Contributing to Calculator](https://github.com/csc510fall23g45/cheapBuy/blob/Project3/CONTRIBUTING.md)
