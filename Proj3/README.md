...
"Docs: doco generated format not ugly "|3| Md files: https://github.com/csc510fall23g45/cheapBuy/blob/Project3/README.md |
Docs: what: point descriptions of each class/function (in isolation) |3| Function_desc .md : https://github.com/csc510fall23g45/cheapBuy/blob/Project3/Proj3/function_description.md |
"Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z" | 3 | Readme : https://github.com/csc510fall23g45/cheapBuy/blob/Project3/README.md - Clear explanation of every feature |
"Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing "|3|Readme: https://github.com/csc510fall23g45/cheapBuy/blob/Project3/README.md |
"Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code. "|3| https://github.com/csc510fall23g45/cheapBuy/blob/Project3/README.md
Use of version control tools |3| https://github.com/csc510fall23g45/cheapBuy |
Use of style checkers |3| https://github.com/csc510fall23g45/cheapBuy/blob/Project3/.github/workflows/style_checker.yml |
Use of code formatters. |3| https://github.com/csc510fall23g45/cheapBuy/blob/Project3/.github/workflows/code_formatter.yml |
Use of syntax checkers. |3| https://github.com/csc510fall23g45/cheapBuy/blob/Project3/.github/workflows/pylint.yml |
Use of code coverage |3| https://github.com/csc510fall23g45/cheapBuy/blob/Project3/.github/workflows/code_cov.yml |
Other automated analysis tools |3| https://github.com/csc510fall23g45/cheapBuy/actions  |
Test cases exist |3| https://github.com/csc510fall23g45/cheapBuy/tree/Project3/test/web_scrappers |
...
"Evidence that the whole team is using the same tools "|3| https://github.com/csc510fall23g45/cheapBuy/graphs/contributors |
Evidence that the members of the team are working across multiple places in the code base |3| https://github.com/csc510fall23g45/cheapBuy/graphs/contributors |
...
"10.4) Is there a branch of the repository that is always stable? (i.e. tests always pass code always builds successfully) "|YES|https://github.com/csc510fall23g45/cheapBuy/tree/Project3
